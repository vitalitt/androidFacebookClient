package com.example.vitalitt.facebookapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void printKeyHash(){
        try{
            PackageInfo info = getPackageManager().getPackageInfo("com.example.vitalitt.facebookapp", PackageManager.GET_SIGNATURES);
